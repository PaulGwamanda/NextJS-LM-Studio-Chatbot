...
export default function PageHome() {
  // store chats
  const { chats, prompt, addChat, loading, removeAllChat, removeOneChat } =
                        ...
                        <div className="text-center text-gray-600">
                          ...
                          <div className="cursor-pointer">
                            <button
                              ...
                              className="my-10"
                              onClick={() => {
                                // Check if the prompt is already in the chats
                                const hasPrompt = chats.some((chat) => chat.prompt === "Hello, how are you?");
                                // Only add the chat if it doesn't exist
                                if (!hasPrompt) {
                                  addChat("Hello, how are you?");
                                }
                              }}>
                                ...
                                <div className="fixed inset-0 overflow-y-auto">
                                  <div className="flex min-h-full items-center justify-center p-4 text-center">
                                    <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                      ...
                                      <Dialog.Description className="mt-1">
                                        Are you sure delete chat {item.prompt} ?
                                      </Dialog.Description>
                                      <div className="mt-4 flex justify-end space-x-4">
                                        <button
                                          type="button"
